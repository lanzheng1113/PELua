...
function 注册Soft2()
	...
	注册表删除键("HKLM","SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer\\HideSCAVolume",false)
	...
	逐级创建目录 = OsExt.LFCreateDirRecursively -- 父目录如果不存在则一并创建
	...
	if 存在路径("X:\\PEPrograms\\X86Soft2\\备份还原\\CGI标准版32位.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\备份还原\\CGI.lnk", "X:\\PEPrograms\\X86Soft2\\备份还原\\CGI标准版32位.exe")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\引导修复\\UEFIX\\UEFIX.EXE") then
		创建快捷方式(开始菜单程序目录 .. "\\引导修复\\UEFI引导修复.lnk", "X:\\PEPrograms\\X86Soft2\\引导修复\\UEFIX\\UEFIX.EXE")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\引导修复\\NTBOOTAUTOFIX\\NTBOOTAUTOFIX.EXE") then
		创建快捷方式(开始菜单程序目录 .. "\\引导修复\\Widnows引导修复.lnk", "X:\\PEPrograms\\X86Soft2\\引导修复\\NTBOOTAUTOFIX\\NTBOOTAUTOFIX.EXE")
	end
	if 存在路径("X:\\WXPE") then
		创建快捷方式(开始菜单程序目录 .. "\\引导修复\\Dism++.lnk", "X:\\PEPrograms\\X86Soft2\\引导修复\\Dism++\\Dism++x86.EXE")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\磁盘光盘\\DiskGenius_Mono.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\磁盘光盘\\分区大师.lnk", "X:\\PEPrograms\\X86Soft2\\磁盘光盘\\DiskGenius_Mono.exe")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\磁盘光盘\\傲梅分区助手\\分区助手PE.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\磁盘光盘\\分区助手.lnk", "X:\\PEPrograms\\X86Soft2\\磁盘光盘\\傲梅分区助手\\分区助手PE.exe")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\磁盘光盘\\磁盘坏道分析修复VICTORIA.EXE") then
		创建快捷方式(开始菜单程序目录 .. "\\磁盘光盘\\磁盘坏道分析修复.lnk", "X:\\PEPrograms\\X86Soft2\\磁盘光盘\\磁盘坏道分析修复VICTORIA.EXE")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\磁盘光盘\\磁盘错误修复NDD2006.EXE") then
		创建快捷方式(开始菜单程序目录 .. "\\磁盘光盘\\磁盘错误修复.lnk", "X:\\PEPrograms\\X86Soft2\\磁盘光盘\\磁盘错误修复NDD2006.EXE")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\磁盘光盘\\Defraggler.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\磁盘光盘\\硬盘碎片整理.lnk", "X:\\PEPrograms\\X86Soft2\\磁盘光盘\\Defraggler.exe")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\磁盘光盘\\BOOTICEx86.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\磁盘光盘\\BOOTICE引导管理.lnk", "X:\\PEPrograms\\X86Soft2\\磁盘光盘\\BOOTICEx86.exe")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\磁盘光盘\\ULTRAISO\\ULTRAISO.EXE") then
		创建快捷方式(开始菜单程序目录 .. "\\磁盘光盘\\ULTRAISO.lnk", "X:\\PEPrograms\\X86Soft2\\磁盘光盘\\ULTRAISO\\ULTRAISO.EXE")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\磁盘光盘\\芯片无忧.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\磁盘光盘\\芯片无忧.lnk", "X:\\PEPrograms\\X86Soft2\\磁盘光盘\\芯片无忧.exe")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\磁盘光盘\\FbinstTool.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\磁盘光盘\\FbinstTool.lnk", "X:\\PEPrograms\\X86Soft2\\磁盘光盘\\FbinstTool.exe")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\文件工具\\IMAGINE\\IMAGINE.EXE") then
		创建快捷方式(开始菜单程序目录 .. "\\文件工具\\Imageine.lnk", "X:\\PEPrograms\\X86Soft2\\文件工具\\IMAGINE\\IMAGINE.EXE")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\文件工具\\DEFORMITYDIR\\DEFORMITYDIR.EXE") then
		创建快捷方式(开始菜单程序目录 .. "\\文件工具\\畸形目录处理.lnk", "X:\\PEPrograms\\X86Soft2\\文件工具\\DEFORMITYDIR\\DEFORMITYDIR.EXE")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\系统维护\\WinNTSetup3\\WinNTSetup_v3.8.8.6_Final_Plus.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\系统维护\\NT6安装器.lnk", "X:\\PEPrograms\\X86Soft2\\系统维护\\WinNTSetup3\\WinNTSetup_v3.8.8.6_Final_Plus.exe")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\系统维护\\NTPWEDIT\\NTPWEDIT.EXE") then
		创建快捷方式(开始菜单程序目录 .. "\\系统维护\\系统密码破解.lnk", "X:\\PEPrograms\\X86Soft2\\系统维护\\NTPWEDIT\\NTPWEDIT.EXE")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\硬件检测\\HDTune.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\硬件检测\\磁盘性能检测.lnk", "X:\\PEPrograms\\X86Soft2\\硬件检测\\HDTune.exe")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\硬件检测\\MEMTEST.EXE") then
		创建快捷方式(开始菜单程序目录 .. "\\硬件检测\\内存条测试.lnk", "X:\\PEPrograms\\X86Soft2\\硬件检测\\MEMTEST.EXE")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\硬件检测\\AIDA64.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\硬件检测\\硬件及系统检测AIDA64.lnk", "X:\\PEPrograms\\X86Soft2\\硬件检测\\AIDA64.exe")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\硬件检测\\DisplayX.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\硬件检测\\显示器测试.lnk", "X:\\PEPrograms\\X86Soft2\\硬件检测\\DisplayX.exe")
	end
	if not 存在路径("X:\\WXPE") then
		创建快捷方式(开始菜单程序目录 .. "\\实用工具\\远程控制AnyDesk.lnk", "X:\\PEPrograms\\X86Soft2\\实用工具\\AnyDesk.exe")
	end
	if 存在路径("X:\\PEPrograms\\X86Soft2\\实用工具\\Sunlogin.exe") then
		创建快捷方式(开始菜单程序目录 .. "\\实用工具\\远程控制向日葵.lnk", "X:\\PEPrograms\\X86Soft2\\实用工具\\Sunlogin.exe")
	end
